...
import { CURATED_TMDB_MOVIES } from './src/data/mockMovies';
import { LeaderboardEntry, Movie } from './src/types';
...
// Initial seed data for vibrant global leaderboard
...
if (!fs.existsSync(LEADERBOARD_FILE)) {
  fs.writeFileSync(LEADERBOARD_FILE, JSON.stringify(INITIAL_LEADERBOARD, null, 2), 'utf-8');
}
